<script lang="ts">
	...
	let swiperStyles: ISwiperStyle = {
		containerClassList: 'innovation-card',
		wrapperClassList: 'py-ng30'
	};
...
<div class="flex flex-col">
	{#if title}
        ...
        {arrowStyle === 'black' ? 'text-black' : 'block'}
	...
	{#if description}
		<h2
			class="mx-ng18 md:mx-ng56 lg:mx-ng64
        text-xl
        font-extralight font-poppins
        {arrowStyle === 'black' ? 'text-black' : 'block'}
        {arrowStyle === 'white' ? 'text-white' : 'text-black'}
        z-ng1"
			data-testId="title"
	...
	{/if}
	<div class="px-6 md:px-12 lg:px-14 overflow-hidden">
		<CustomSwiper
