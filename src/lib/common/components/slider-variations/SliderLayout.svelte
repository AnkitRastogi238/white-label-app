<script lang="ts">
	...
	import Slider from '$lib/common/components/card-slider/Slider.svelte';
	import type { CardList } from '$lib/common/types';

	/**
	 * An object containing data for the regular card slider.
	 */
	export let slider: CardList;
